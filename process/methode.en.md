...
> See also: [GENESIS.md](../GENESIS.md) (how it was born, FR) · [personas-et-decision.md](personas-et-decision.md) (who decides, FR) · [exemples-et-schemas.en.md](exemples-et-schemas.en.md) (diagrams + examples).
